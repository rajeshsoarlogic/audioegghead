...
/**
 * Content Writer
 * Copyright (C) 2018 SteadyContent
...
// Constants
if (!defined('CONWR_VERSION')) define('CONWR_VERSION', '3.5.8');
...
add_filter('pre_set_site_transient_update_plugins', 'conwr_transient_update_plugin');
