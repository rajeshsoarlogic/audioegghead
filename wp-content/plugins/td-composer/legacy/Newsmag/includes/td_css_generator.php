...
function td_css_generator() {
    ...
    body .td-block-color-style-1 .td_ajax_load_more {
    	border-color: @style_1_block_navigation_text_color !important;
        color: @style_1_block_navigation_text_color !important;
    }
    ...
    body .td-block-color-style-2 .td_ajax_load_more {
    	border-color: @style_2_block_navigation_text_color !important;
        color: @style_2_block_navigation_text_color !important;
    }
    ...
    body .td-block-color-style-3 .td_ajax_load_more {
    	border-color: @style_3_block_navigation_text_color !important;
        color: @style_3_block_navigation_text_color !important;
    }
    ...
    body .td-block-color-style-4 .td_ajax_load_more {
    	border-color: @style_4_block_navigation_text_color !important;
        color: @style_4_block_navigation_text_color !important;
    }
    ...
    body .td-block-color-style-5 .td_ajax_load_more {
    	border-color: @style_5_block_navigation_text_color !important;
        color: @style_5_block_navigation_text_color !important;
    }
    ...
    body .td-block-color-style-6 .td_ajax_load_more {
    	border-color: @style_6_block_navigation_text_color !important;
        color: @style_6_block_navigation_text_color !important;
    }
