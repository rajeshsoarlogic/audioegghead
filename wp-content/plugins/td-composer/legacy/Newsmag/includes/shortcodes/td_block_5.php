...
class td_block_5 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        // module 3 fonts
        $res_ctx->load_font_settings( 'm3f_title' );
        $res_ctx->load_font_settings( 'm3f_cat' );
        $res_ctx->load_font_settings( 'm3f_meta' );
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @m3f_title */
				.$unique_block_class .td_module_3 .entry-title {
					@m3f_title
				}
				/* @m3f_cat */
				.$unique_block_class .td_module_3 .td-post-category {
					@m3f_cat
				}
				/* @m3f_meta */
				.$unique_block_class .td_module_3 .meta-info,
				.$unique_block_class .td_module_3 .td-module-comments a {
					@m3f_meta
				}
			</style>";
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            foreach ($posts as $post) {
                $td_module_3 = new td_module_3($post, $this->get_all_atts());
