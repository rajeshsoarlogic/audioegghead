...
class td_block_14 extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @mx1f_meta */
				.$unique_block_class .td_module_mx1 .meta-info,
				.$unique_block_class .td_module_mx1 .td-module-comments a {
					@mx1f_meta
				}
			</style>";
            ...
            foreach ($posts as $post) {
                ...
                switch ($td_column_number) {
                    ...
                    case '1': //one column layout
                        ...
                        $buffy .= $td_module_mx1->render($post);
