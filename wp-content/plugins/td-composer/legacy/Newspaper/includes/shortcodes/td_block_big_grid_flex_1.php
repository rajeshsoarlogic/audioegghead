        ...
        $raw_css =
            "<style>
				...
				@media (min-width: 767px) {
                    ...
                    .$unique_block_class .td-big-grid-flex-post:nth-last-child(@padding) {
                    ...
                    .$unique_block_class .td-big-grid-flex-post:nth-last-child(@padding) .td-module-container:before {
