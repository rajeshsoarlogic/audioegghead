...
class td_module_mx23 extends td_module {
    ...
    function render($order_no) {
        ob_start();
        $title_length = $this->get_shortcode_att('mx23_tl');
            ...
            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <?php if (td_util::get_option('tds_category_module_mx23') == 'yes') { echo $this->get_category(); }?>
