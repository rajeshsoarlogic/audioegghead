...
class tds_button7 extends td_style {
    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				/* @border_top_color_solid */
				body .$unique_style_class .tdm-btn-border-top {
					background-color: @border_top_color_solid;
				}
				/* @border_top_color_gradient */
				.$unique_style_class .tdm-btn-border-top {
				    @border_top_color_gradient
				}
				/* @border_top_hover_color */
				...
				.$unique_style_class .tdm-btn-border-bottom {
				    @border_bottom_color_gradient
				}
				...
				/* @border_top_size */
				.$unique_style_class .tdm-btn-border-top {
					height: @border_top_size;
				}
				/* @border_bottom_size */
				.$unique_style_class .tdm-btn-border-bottom {
					height: @border_bottom_size;
				}
				/* @border_radius */
				.$unique_style_class,
				.$unique_style_class .tdm-btn-border-top {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'border_top_size', $border_top_size );
        if( $border_top_size != '' ) {
            if( is_numeric( $border_top_size ) ) {
                $res_ctx->load_settings_raw( 'border_top_size', $border_top_size . 'px' );
            }
        } else {
            $res_ctx->load_settings_raw( 'border_top_size', '2px' );
        }

        // top border color
        $res_ctx->load_color_settings( 'border_top_color', 'border_top_color_solid', 'border_top_color_gradient', '', '', __CLASS__ );
        ...
        $res_ctx->load_settings_raw( 'border_bottom_size', $border_bottom_size );
        if( $border_bottom_size != '' ) {
            if( is_numeric( $border_bottom_size ) ) {
                $res_ctx->load_settings_raw( 'border_bottom_size', $border_bottom_size . 'px' );
            }
        } else {
            $res_ctx->load_settings_raw( 'border_bottom_size', '2px' );
        }

        // bottom border color
        $res_ctx->load_color_settings( 'border_bottom_color', 'border_bottom_color_solid', 'border_bottom_color_gradient', 'border_bottom_color_gradient_1', 'border_bottom_color_params', __CLASS__ );
