...
// The custom HTML needs to be here in "td-outer-wrap" to be at the end of the content.
// We moved this code from wp_footer();
...
?>
    <!-- custom html -->
    <div class="td-container td-custom-html-mob"><?php echo $td_custom_html_mob ?></div>
<?php
}
?>
