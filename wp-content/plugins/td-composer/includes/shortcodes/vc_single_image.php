...
class vc_single_image extends td_block {
	...
	public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @effect_on */
				.$unique_block_class .td_single_image_bg {
					filter: @fe_brightness @fe_contrast @fe_grayscale @fe_sepia @fe_blur @fe_hue_rotate @fe_saturate;
				}
				/* @height */
				.$unique_block_class .td_single_image_bg {
					height: @height;
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw('global', 1);
	...
	function render($atts, $content = null) {
		...
		if ( !empty($atts['image']) ) {
			...
			$buffer = '<div class="wpb_wrapper td_block_single_image ' . $this->get_wrapper_class() . ' ' . $no_custom_url . ' ' . $this->get_block_classes( array(
					$atts['el_class'],
					$editing_class,
