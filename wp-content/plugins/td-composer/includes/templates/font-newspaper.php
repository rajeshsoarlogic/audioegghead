...
<span data-font_class="td-icon-diamond-fill"><i class="td-icon-diamond-fill td-size-big"></i></span>
<span data-font_class="td-icon-mountains-lines"><i class="td-icon-mountains-lines td-size-big"></i></span>
<span data-font_class="td-icon-x-lines"><i class="td-icon-x-lines td-size-big"></i></span>
<span data-font_class="td-icon-abstract-circle-lines"><i class="td-icon-abstract-circle-lines td-size-big"></i></span>
<span data-font_class="td-icon-abstract-lines-emblem"><i class="td-icon-abstract-lines-emblem td-size-big"></i></span>
<span data-font_class="td-icon-Z-letter-lines"><i class="td-icon-Z-letter-lines td-size-big"></i></span>
<span data-font_class="td-icon-star-squares-lines"><i class="td-icon-star-squares-lines td-size-big"></i></span>
<span data-font_class="td-icon-star-squares-fill"><i class="td-icon-star-squares-fill td-size-big"></i></span>
<span data-font_class="td-icon-star1-flower"><i class="td-icon-star1-flower td-size-big"></i></span>
<span data-font_class="td-icon-heart-flower"><i class="td-icon-heart-flower td-size-big"></i></span>
<span data-font_class="td-icon-star-hex"><i class="td-icon-star-hex td-size-big"></i></span>
<span data-font_class="td-icon-bird-origami-lines"><i class="td-icon-bird-origami-lines td-size-big"></i></span>
<span data-font_class="td-icon-decorative-flower1"><i class="td-icon-decorative-flower1 td-size-big"></i></span>
<span data-font_class="td-icon-hand-holding-flower"><i class="td-icon-hand-holding-flower td-size-big"></i></span>
<span data-font_class="td-icon-moon-stars1-line"><i class="td-icon-moon-stars1-line td-size-big"></i></span>
<span data-font_class="td-icon-abstract-owl-lines"><i class="td-icon-abstract-owl-lines td-size-big"></i></span>
<span data-font_class="td-icon-abstract-lines-model"><i class="td-icon-abstract-lines-model td-size-big"></i></span>
<span data-font_class="td-icon-owl-lines"><i class="td-icon-owl-lines td-size-big"></i></span>
<span data-font_class="td-icon-buck-fill"><i class="td-icon-buck-fill td-size-big"></i></span>
<span data-font_class="td-icon-lines-loader"><i class="td-icon-lines-loader td-size-big"></i></span>
<span data-font_class="td-icon-trees-circle"><i class="td-icon-trees-circle td-size-big"></i></span>
<span data-font_class="td-icon-moon-stars-line"><i class="td-icon-moon-stars-line td-size-big"></i></span>
<span data-font_class="td-icon-line3-thin"><i class="td-icon-line3-thin td-size-big"></i></span>
<span data-font_class="td-icon-line2-thin"><i class="td-icon-line2-thin td-size-big"></i></span>
<span data-font_class="td-icon-line1-thin"><i class="td-icon-line1-thin td-size-big"></i></span>
<span data-font_class="td-icon-line3-thik"><i class="td-icon-line3-thik td-size-big"></i></span>
<span data-font_class="td-icon-line2-thik"><i class="td-icon-line2-thik td-size-big"></i></span>
<span data-font_class="td-icon-line1-thik"><i class="td-icon-line1-thik td-size-big"></i></span>
<span data-font_class="td-icon-wreath3-fill"><i class="td-icon-wreath3-fill td-size-big"></i></span>
<span data-font_class="td-icon-wreath2-fill"><i class="td-icon-wreath2-fill td-size-big"></i></span>
<span data-font_class="td-icon-wreath1-fill"><i class="td-icon-wreath1-fill td-size-big"></i></span>
<span data-font_class="td-icon-wreath-fill"><i class="td-icon-wreath-fill td-size-big"></i></span>
<span data-font_class="td-icon-wreath-line"><i class="td-icon-wreath-line td-size-big"></i></span>
<span data-font_class="td-icon-flower-branch-vertical"><i class="td-icon-flower-branch-vertical td-size-big"></i></span>
<span data-font_class="td-icon-branch1-vertical-fill"><i class="td-icon-branch1-vertical-fill td-size-big"></i></span>
<span data-font_class="td-icon-branch-vertical-fill"><i class="td-icon-branch-vertical-fill td-size-big"></i></span>
<span data-font_class="td-icon-flower-vertical-line"><i class="td-icon-flower-vertical-line td-size-big"></i></span>
<span data-font_class="td-icon-leaves-vertical-line"><i class="td-icon-leaves-vertical-line td-size-big"></i></span>
<span data-font_class="td-icon-leaves-vertical-fill"><i class="td-icon-leaves-vertical-fill td-size-big"></i></span>
<span data-font_class="td-icon-separator3-wave"><i class="td-icon-separator3-wave td-size-big"></i></span>
<span data-font_class="td-icon-separator2-wave"><i class="td-icon-separator2-wave td-size-big"></i></span>
<span data-font_class="td-icon-separator1-wave"><i class="td-icon-separator1-wave td-size-big"></i></span>
<span data-font_class="td-icon-separator-wave"><i class="td-icon-separator-wave td-size-big"></i></span>
<span data-font_class="td-icon-separator2-straigth"><i class="td-icon-separator2-straigth td-size-big"></i></span>
<span data-font_class="td-icon-separator1-straigth"><i class="td-icon-separator1-straigth td-size-big"></i></span>
<span data-font_class="td-icon-separator-straigth"><i class="td-icon-separator-straigth td-size-big"></i></span>
<span data-font_class="td-icon-leaves-left-fill"><i class="td-icon-leaves-left-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves-left-line"><i class="td-icon-leaves-left-line td-size-big"></i></span>
<span data-font_class="td-icon-leaves1-left-fill"><i class="td-icon-leaves1-left-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves5-right-fill"><i class="td-icon-leaves5-right-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves4-right-fill"><i class="td-icon-leaves4-right-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves3-right-fill"><i class="td-icon-leaves3-right-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves1-right-line"><i class="td-icon-leaves1-right-line td-size-big"></i></span>
<span data-font_class="td-icon-leaves2-right-fill"><i class="td-icon-leaves2-right-fill td-size-big"></i></span>
<span data-font_class="td-icon-leaves1-right-fill"><i class="td-icon-leaves1-right-fill td-size-big"></i></span>
