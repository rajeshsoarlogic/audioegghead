    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				.td-md-is-ios .$unique_block_class .tdb-logo-a:hover .tdb-logo-text-tagline {
					-webkit-text-fill-color: initial;
				}
    ...
    function render( $atts, $content = null ) {
        ...
        $buffy .= '<div class="' . $this->get_block_classes() . ' tdb-header-align" ' . $this->get_block_html_atts() . '>';
            ...
            if( $logo_image != '' ) {
                ...
                $logo_image_width_html = 'width="' . $logo_image_width . 'px"';
            }
            // logo retina image
            ...
            if( $logo_retina_image != '' || $logo_image != '' ) {
                $logo_image_html .= '<div class="tdb-logo-img-wrap">';
                    if( $logo_retina_image != '' ) {
