 ...
 * Author: tagDiv
 * Version: 1.2 | built on 25.04.2019 9:32
...
//hash
define('TD_MOBILE_PLUGIN', '165a438ed6bbaeb7665cc45f9ebc3263');
...
td_mobile_theme::set_theme_options($main_theme->get( 'Template' ));
...
function td_on_mobile_ajax_search() {
	...
	if (
	        td_mobile_theme::is_mobile( true ) ||
            ( td_mobile_theme::get_option('tdm_amp') !== '' && td_mobile_theme::is_amp_request() )
    ) {
