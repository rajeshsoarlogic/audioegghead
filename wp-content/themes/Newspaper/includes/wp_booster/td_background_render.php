...
class td_background_render {
    ...
    private function add_js_hook() {
            ob_start();
            // !!!! chestia asta ar trebuii trecuta pe flag sau ceva in td_config ?
            ?>
            ...
            <script>
                ...
                if ( 'undefined' !== typeof window.tdBackstr ) {
                    ...
                    (function(){
                        ...
                        var image_jquery_obj = jQuery( '<img class=\'td-backstretch not-parallax\' src=\'<?php echo esc_url( $this->background_parameters['theme_bg_image'] ) ?>\'>' );
