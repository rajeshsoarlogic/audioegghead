            ...
            <div class="wrap">
                ...
                <div class="td-container-wrap">
                    ...
                    <div class="td-panel-main-header">
                        <img src="<?php echo get_template_directory_uri() . '/includes/wp_booster/wp-admin/images/panel/panel-wrap/panel-logo.png'?>" alt="Panel logo"/>
                            ...
                            <div id="td-col-right" class="td-panel-content">
                                ...
                                foreach ($all_theme_panels_list[$panel_spot_id]['panels'] as $panel_id => $panel_array) {
                                    if (isset($panel_array['file'])) {
                                        ...
                                        ?>
                                        <div id="<?php echo esc_attr( $panel_id ) ?>" class="<?php echo esc_attr( $td_panel_active ) ?> td-panel">
                                            <?php
            ...
            if (isset($panel_array['file']) and strpos($panel_array['file'], $td_ajax_calling_file) !== false) {
                ...
                if ($panel_array['type'] == 'in_theme') {
                    ...
                    if (empty($td_template_found_in_theme_or_child)) {
                        require_once(td_global::$get_template_directory . '/includes/wp_booster/wp-admin/panel/views/ajax_boxes/' . $td_ajax_calling_file_id . '/' . $td_ajax_box_id . '.php');
                    }
                    $buffy = ob_get_clean();
