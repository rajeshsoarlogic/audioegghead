...
class td_panel_data_source {
    ...
    static function read($read_array) {
        switch ($read_array['ds']) {
            ...
            case 'wp_option': //!!!! - se poate sa nu mai fie folosita
            ...
            //author metadata
            case 'td_author': //!!!! - se poate sa nu fie folosita
                return get_the_author_meta($read_array['option_id'], $read_array['item_id']);
                break;


            //wordpress theme mod datasource !!!! - se poate a nu mai fie folosita
            case 'wp_theme_mod':
    ...
    static function update() {
        ...
        foreach ($_POST as $post_data_source => $post_value) {
            switch ($post_data_source) {
	            ...
	            //wp
                case 'td_author': //!!!! - se poate sa nu mai fie folosita
                    self::update_td_author($post_value);
                    break;

                case 'wp_theme_mod': //!!!! - se poate sa nu mai fie folosita
