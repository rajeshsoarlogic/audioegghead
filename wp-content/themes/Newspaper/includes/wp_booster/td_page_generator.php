            ...
            if ($pagination_style != '') {
                ...
                <script>
                    jQuery(window).ready(function() {
                        tdAjaxLoop.loopState.sidebarPosition = '<?php printf( '%1$s', $loop_sidebar_position ) ?>';
                        tdAjaxLoop.loopState.moduleId = '<?php printf( '%1$s', $loop_module_id ) ?>';
                        ...
                        if ( -1 === <?php printf( '%1$d', $wp_query->max_num_pages ) ?>) {
		                    tdAjaxLoop.loopState.max_num_pages = <?php printf( '%1$d', $wp_query->max_num_pages ) ?>;
	                    } else {
		                    tdAjaxLoop.loopState.max_num_pages = <?php printf( '%1$d',  ceil(($wp_query->found_posts - $wp_query->query_vars['offset']) / $wp_query->query_vars['posts_per_page']) ) ?>;
	                    }

                        tdAjaxLoop.loopState.atts = {
                            'category_id':<?php printf( '%1$s', $wp_query->query_vars['cat'] ) ?>
                        ...
                        tdAjaxLoop.loopState.ajax_pagination_infinite_stop = <?php printf( '%1$s', $ajax_pagination_infinite_stop ) ?>;
                        tdAjaxLoop.init();
                    });
                </script>
                <?php
