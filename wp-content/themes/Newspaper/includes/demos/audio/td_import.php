...
$td_cloud_global_header_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/global_header_cloud_template.txt',
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/post_cloud_template.txt',
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/cat_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/author_cloud_template.txt',
...
$td_cloud_search_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/search_cloud_template.txt',
...
$td_cloud_date_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/date_cloud_template.txt',
    'template_type' => 'date',
));
...
$td_cloud_tag_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/tag_cloud_template.txt',
    'template_type' => 'tag',
));
// set the default site wide date template
...
$td_cloud_404_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/homepage.txt',
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/footer-template.txt',
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/video_pro/pages/post_default.txt',
