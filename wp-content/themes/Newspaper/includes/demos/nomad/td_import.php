...
$td_cloud_global_header_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/global_header_cloud_template.txt',
...
$td_cloud_front_header_template_id2 = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/front_header_cloud_template.txt',
    'template_type' => 'header',
));
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/post_cloud_template.txt',
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/cat_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/author_cloud_template.txt',
...
$td_cloud_search_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/search_cloud_template.txt',
...
$td_cloud_404_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/homepage.txt',
...
$td_footertemplate_id = td_demo_content::add_page(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/footer-template.txt',
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/nomad/pages/post_default.txt',
