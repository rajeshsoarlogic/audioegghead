	...
	class Vmagazine_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Required Plugins', 'vmagazine-lite'),
					...
					'changelog' => esc_html__('ChangeLog', 'vmagazine-lite'),
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) /*&& (isset($_GET['activated']))*/ ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						<h2><?php printf(__( 'Welcome!', 'vmagazine-lite' )) ?></h2>
						<p class="about-desc"><?php printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'vmagazine-lite' ), $this->theme_name);  ?></p>
						<hr/>
							...
							<div class="apwelcome-column col-demos">
								<div>
									<h3>
										...
										<?php printf(__( 'Starter site demos!', 'vmagazine-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got 3 choices of great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'vmagazine-lite' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page#demo_import' )  ); ?></p>
								</div>
								<div>
									<div class="button-wrapper">
										<a class="button button-primary button-hero install-now" href="<?php echo admin_url( 'themes.php?page=welcome-page#demo_import' ) ?>"><?php esc_html_e( 'ready to use starter sites.', 'vmagazine-lite' ); ?></a>
									</div>

									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'vmagazine-lite' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'vmagazine-lite' ); ?></p>
									<a href="https://accesspressthemes.com/support/" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'vmagazine-lite' ); ?></span></a>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(__( 'Documentation', 'vmagazine-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'vmagazine-lite' ), $this->theme_name  ); ?></p>
									<a href="<?php echo esc_url($this->strings['doc_link']);?>" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'vmagazine-lite' ); ?></span></a>

								</div>
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'vmagazine-lite' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="wrap about-wrap access-wrap">
					<div class="top-block-wrap">
						<div class="about-text">
							<h1><?php printf( esc_html__( 'Welcome to %s - Version %s', 'vmagazine-lite' ), $this->theme_name, $this->theme_version ); ?></h1>
								...
								<div class="welcome-section-wrapper is_loading">
									<?php foreach($tabs as $id => $label) : ?>
										<div class="welcome-section <?php echo esc_attr($id);?> nav-tab-inactive clearfix">
											<?php 
											if($id == 'changelog'){
												require_once get_stylesheet_directory() . '/inc/welcome/sections/'.esc_html($id).'.php';
											}else{
												require_once get_template_directory() . '/inc/welcome/sections/'.esc_html($id).'.php';
											}
											?>
										</div>
									<?php endforeach; ?>
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','vmagazine-lite') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'vmagazine-lite'); ?></p>

											<p><a href="https://www.facebook.com/AccessPressThemes"><?php echo esc_html('Join our Facebook Group','vmagazine-lite') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'vmagazine-lite'); ?></p>

											<p><a href="https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w"><?php echo esc_html('Subscribe our YouTube Channel','vmagazine-lite') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'vmagazine-lite'); ?></p>

											<p><a href="https://twitter.com/apthemes"><?php echo esc_html('Follow us on Twitter','vmagazine-lite') ?></a><?php echo esc_html__(' -to stay updated. ', 'vmagazine-lite'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','vmagazine-lite') ?></h4>
											<p><?php  printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'vmagazine-lite'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/vmagazine-lite/reviews/#new-post"><?php echo esc_html('Write a review','vmagazine-lite') ?></a>
