<?php
/**
* Vmagazine Pro repeater customizer
*
...
*/
  function vmagazine_lite_enqueue_repeater_scripts() {
    wp_enqueue_script( 'vmagazine-lite-repeater-script', get_template_directory_uri() . '/inc/customizer/repeater-controller/repeater-script.js',array( 'jquery','jquery-ui-sortable'));
    wp_enqueue_style('vmagazine-lite-repeater-style',get_template_directory_uri() . '/inc/customizer/repeater-controller/repeater-style.css');
} add_action( 'admin_enqueue_scripts', 'vmagazine_lite_enqueue_repeater_scripts');

/**
* Repeater customizer
*/
add_action( 'customize_register', 'vmagazine_lite_repeaters_customize_register' );
function vmagazine_lite_repeaters_customize_register( $wp_customize ) {
...
*
*/
$wp_customize->add_setting( 'vmagazine_lite_social_icons', array(
    'sanitize_callback' => 'vmagazine_lite_sanitize_repeater',
...
$wp_customize->add_control(  new vmagazine_lite_Repeater_Controler( $wp_customize, 'vmagazine_lite_social_icons', 
    array(
        'label'                     => esc_html__('Social Icons Option','vmagazine-lite'),
        'section'                   => 'vmagazine_lite_header_icons',
        'vmagazine_lite_box_label'         => esc_html__('Social Icons','vmagazine-lite'),
        'vmagazine_lite_box_add_control'   => esc_html__('Add Profile','vmagazine-lite'),
        'vmagazine_lite_no_of_opts' => 5
    ),
    array(
        'social_icons' => array(
        'type'        => 'social_icon',
        'label'       => esc_html__( 'Choose Icon', 'vmagazine-lite' ),
        'default'     => '',
        ...
        'social_url' => array(
        'type'        => 'url',
        'label'       => esc_html__( 'Enter URL', 'vmagazine-lite' ),
        'default'     => '',
        'class'       => 'un-bottom-block-cat1'
        )  
    )
        ...
        * Repeater Sanitize
        */
        function vmagazine_lite_sanitize_repeater($input){      
 ...
 * @since 1.0.0
 */
 function vmagazine_lite_icons_array(){
    $ap_icon_list_raw = 
 ...
 /*--------------------------------------------------------------------------------------------------------------------------*/
 /**
 * Fontawesome social icons array
 *
 */
 function vmagazine_lite_social_icons_arrays(){
     ...
     $social_networks = array(
        ...
        'stackoverflow.com'  => array( 'name' => 'Stack Exchange', 'class' => 'stackexchange', 'icon' => 'fa-stack-exchange', 'icon-sign' => 'fa-stack-exchange'    ),
