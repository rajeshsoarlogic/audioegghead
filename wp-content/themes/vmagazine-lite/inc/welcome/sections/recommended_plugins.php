<?php
	...
	if( !empty($this->pro_plugins) ) {
		...
		<div class="recom-plugin-info">
			<p><?php echo esc_html('Here are some free and premium plugins recommendation from us. You can build even better websites using these plugins.','vmagazine-lite'); ?></p>
		</div>
						...
						<div class="recom-plugin-inner-wrapper">
							<div class="plugin-img-wrap">
								...
								<div class="version-author-info">
									<span class="version"><?php echo esc_html__('Version ', 'vmagazine-lite') . esc_html($plugin['version']); ?></span>
				...
				<div class="recom-plugin-wrap">
					<div class="recom-plugin-inner-wrapper">
						...
						<div class="plugin-title-install clearfix">
							...
							<span class="plugin-action-btn plugin-btn-wrapper plugin-card-<?php echo esc_attr($plugin['slug']); ?>">
								<a class="view-detail"  href="<?php echo esc_attr($link); ?>"><?php echo esc_html__('View Detail', 'vmagazine-lite');  ?></a>
							</span>
							<div class="version-author-info">
								<span class="version"><?php printf( $plugin['version']); ?></span>
								<span class="seperator">|</span>
								<span class="author"><?php echo esc_html($plugin['author']); ?></span>
							</div>
						</div>
					...
					<div class="recom-plugin-inner-wrap">
						...
						<div class="plugin-title-install clearfix">
							...
							<div class="version-author-info free">
								<span class="version"><?php echo esc_html__('Version ', 'vmagazine-lite') . esc_html($info->version); ?></span>
								<span class="seperator">|</span>
